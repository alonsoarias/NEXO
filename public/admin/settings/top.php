...
// Registration removed - not needed for this installation
...
// Hidden categories for removed components (courses, grades, analytics, competencies, badges, h5p, payment)
$ADMIN->add('root', new admin_category('courses', new lang_string('courses','admin'), true));
$ADMIN->add('root', new admin_category('grades', new lang_string('grades'), true));
